...
![ip a user-2](./images/part21.png)

*  измененный 00-installer-config.yaml
![user-1](./images/part22.png)
![user-2](./images/part23.png)
* `sudo netplan apply`
![user-1](./images/part24.png)
![user-2](./images/part25.png)
* `sudo ip r add 192.168.100.10 dev enp0s3`
* `sudo ip r add 172.24.116.8 dev enp0s3`
* `ping -c 192.168.100.10`
* `ping -c 172.24.116.8`
![user-1 static](./images/part26.png)
![user-2 static](./images/part27.png)
* статический маршрут от одной машины до другой с помощью файла etc/netplan/00-installer-config.yaml
![user-1 00-installer](./images/part28.png)
![user-2 00-installer](./images/part29.png)
